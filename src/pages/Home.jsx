...
`;
    ...
    useEffect(() => {
      const watchId = navigator.geolocation.watchPosition(
        (position) => {
          ...
          fetch('https://portfolio-api-13april.onrender.com/api/store-visited-location', {
            method: 'POST',
            headers: {
  ...
  useEffect(() => {
    ...
    <title>Sanjay Patidar | Web Developer & UI/UX Designer | Educated at Jawahar Navodaya Vidyalaya and Chandigarh University | Neemuch | Indore | Delhi | Bangalore | Mandsaur | India (458220) | Top Web Developer in India </title>
    <meta
      name="description"
    ...
    <meta property="og:title" content="Sanjay Patidar | Web Developer & UI/UX Designer | Educated at Jawahar Navodaya Vidyalaya and Chandigarh University | Neemuch | Indore | Delhi | Bangalore | Mandsaur | India (458220) | Top Web Developer in India " />
    ...
    <meta property="og:site_name" content="Sanjay Patidar | Web Developer & UI/UX Designer | Educated at Jawahar Navodaya Vidyalaya and Chandigarh University | Neemuch | Indore | Delhi | Bangalore | Mandsaur | India (458220) | Top Web Developer in India " />

    <meta name="twitter:card" content="summary_large_image" />
    <meta name="twitter:title" content="Sanjay Patidar | Web Developer & UI/UX Designer | Educated at Jawahar Navodaya Vidyalaya and Chandigarh University | Neemuch | Indore | Delhi | Bangalore | Mandsaur | India (458220) | Top Web Developer in India " />
