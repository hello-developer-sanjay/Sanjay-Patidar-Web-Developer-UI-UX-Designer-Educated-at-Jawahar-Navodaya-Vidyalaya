...
let endpoint = "submit-feedback";
  ...
  <button onClick={copyInstaID} style={{ marginLeft: '4px', color: '#000501', padding: '2px 4px', border: '2px solid #ff6b6b', borderRadius: '30px', cursor: 'pointer' }}>Copy Insta ID</button>
    ...
    <Text>➥ Curious to know more about EduXcel <a style={{ color: '#FAF7F7', padding: '2px 4px', border: '2px solid #ff6b6b', borderRadius: '30px', cursor: 'pointer', textDecoration: "none" }} href="https://eduxcel.vercel.app" target="_blank">EduXcel WebLink</a> to explore!</Text>
  </Introduction>
</Onlyforlap>
</FlexContainer>
