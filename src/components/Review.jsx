...
const Review = () => {
  ...
  useEffect(() => {
    const fetchReviews = async () => {
      try {
        const response = await axios.get('https://portfolio-api-16july.onrender.com/comments');
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post('https://portfolio-api-16july.onrender.com/comments', {
        username,
        comment,
      });
