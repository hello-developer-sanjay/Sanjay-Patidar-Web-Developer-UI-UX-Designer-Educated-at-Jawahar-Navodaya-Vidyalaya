    ...
    async function fetchCourses() {
      try {
        ...
        if (!category || category === 'all') {
          response = await axios.get('https://eduxcel-api-5jun.onrender.com/api/courses/category/all');
        } else {
          response = await axios.get(`https://eduxcel-api-5jun.onrender.com/api/courses/category/${category}`);
        }
        if (!response) {
          response = await axios.get('https://eduxcel-api-5jun.onrender.com/api/courses/category');
        }
