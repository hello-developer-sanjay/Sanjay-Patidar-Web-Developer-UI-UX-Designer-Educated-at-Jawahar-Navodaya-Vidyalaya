...
const Resume = () => {
  ...
  const handleResumeClick = async () => {
    try {
      ...
      await fetch('https://portfolio-api-u3de.onrender.com/api/increment-resume-clicks', {
        method: 'POST',
        headers: {
      ...
      const response = await fetch('https://portfolio-api-u3de.onrender.com/api/get-resume-click-count');
