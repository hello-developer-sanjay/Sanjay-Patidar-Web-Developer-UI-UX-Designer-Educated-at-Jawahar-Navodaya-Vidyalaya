...
const Resume = () => {
  const pdfResumeUrl = 'https://sanjaybasket.s3.ap-south-1.amazonaws.com/Resume-ATS92/Sanjay_Patidar-Resume_Web-Developer.pdf';
  ...
  const handleResumeClick = async () => {
    try {
      ...
      await fetch('https://portfolio-api-15jun.onrender.com/api/increment-resume-clicks', {
        method: 'POST',
        headers: {
      ...
      const response = await fetch('https://portfolio-api-15jun.onrender.com/api/get-resume-click-count');
