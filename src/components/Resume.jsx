...
const Resume = () => {
  const pdfResumeUrl = 'https://sanjaybasket.s3.ap-south-1.amazonaws.com/Developer-Resume/Sanjay-Patidar-Resume_Web-Developer-ATS92.pdf';
  ...
  const handleResumeClick = async () => {
    try {
      ...
      await fetch('https://portfolio-api-5jun.onrender.com/api/increment-resume-clicks', {
        method: 'POST',
        headers: {
      ...
      const response = await fetch('https://portfolio-api-5jun.onrender.com/api/get-resume-click-count');
