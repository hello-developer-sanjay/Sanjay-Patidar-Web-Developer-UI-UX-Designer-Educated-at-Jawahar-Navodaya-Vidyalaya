...
const backendBaseUrl = "https://p-back-aruc.onrender.com"; 
...
const Blogs = () => {
  ...
  const fetchBlogs = async () => {
    try {
      const response = await axios.get('https://p-back-aruc.onrender.com/api/blogs');
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (editingBlogId) {
        ...
        await axios.post('https://p-back-aruc.onrender.com/api/blogs', formData, {
          headers: {
            'Content-Type': 'multipart/form-data',
          },
        });
  ...
  <BlogContentItem key={index}>
    ...
    {section.type === 'image' && (
      <div>
        ...
        />
        {section.url && <img src={`https://p-back-aruc.onrender.com${section.url}`} alt={`Image ${index}`} />}
      </div>
    )}
      ...
      <div>
        ...
        {section.url && (
          <video width="320" height="240" controls>
            <source src={`https://p-back-aruc.onrender.com${section.url}`} type="video/mp4" />
